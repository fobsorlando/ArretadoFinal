...
public class SecaoFormController implements Initializable {

	
	private Secao entidade;
	...
	public void setSecao(Secao entidade) {
	...
	private Secao getFormData() {
		...
		obj.setNo_secao(txtName.getText());
	...
	public void updateFormData() {
		...
		txtName.setText(entidade.getNo_secao());
