...
public class SubGrupoFormController implements Initializable {

	
	private SubGrupo entidade;
	...
	public void setSubGrupo(SubGrupo entidade) {
	...
	private SubGrupo getFormData() {
		...
		obj.setNo_subGrupo(txtName.getText());
	...
	public void updateFormData() {
		...
		txtName.setText(entidade.getNo_subGrupo());
